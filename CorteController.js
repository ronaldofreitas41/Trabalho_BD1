class CorteController {
  constructor(formIdCreate, formIdUpdate, tableId, cont) {
    ...
    this.boxCreateEl = document.getElementById("box-animal-createC");
    this.boxUpdateEl = document.getElementById("box-animal-updateC");
  ...
  onEdit() {
    document.querySelector("#box-animal-updateC .btn-cancel").addEventListener("click", (e) => {
  ...
  selectAll(cont) {
    if (cont == 0) {
      let animals = Animal.getAnimalStorage("C");
